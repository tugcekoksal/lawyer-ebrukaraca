  ...
  return (
    <>
      <section
        ...
        className="relative grid grid-cols-1 sm:grid-cols-2  justify-center bg-cover items-center m-6 md:m-[7rem]  shadow-2xl bg-center h-screen px-2 sm:px-[5rem] overflow-hidden "
      >
